jQuery(document).ready(function ($) {
	...
	// $('#js-carousel-1').owlCarousel(cfg_for_owl);
    // cfg_for_owl.autoplayTimeout = 6000;
	// $('#js-carousel-2').owlCarousel(cfg_for_owl);
    // cfg_for_owl.autoplayTimeout = 3300;
	// $('#js-carousel-3').owlCarousel(cfg_for_owl);
    // cfg_for_owl.autoplayTimeout = 4000;
	// $('#js-carousel-4').owlCarousel(cfg_for_owl);
	...
	function init_countdown() {
		...
		$('[data-countdown="countdown"]').each(function (index, el) {
			...
			$this.ENGO_CountDown({
				...
				DisplayFormat:
					'<ul><li><span>%%D%% </span>days</li><li><span>%%H%% </span>hours</li><li><span>%%M%% </span>mins</li><li><span>%%S%%</span>secs</li></ul>',
				FinishMessage: 'Expired',
			});
		});
	}
	...
	function init_countdown2() {
		...
		$('[data-countdown="countdownver2"]').each(function (index, el) {
			...
			$this.ENGO_CountDown({
				TargetDate: $date[0] + '/' + $date[1] + '/' + $date[2] + ' ' + $date[3] + ':' + $date[4] + ':' + $date[5],
				DisplayFormat:
					'<ul><li><span>%%H%% </span>Hrs</li><li><span>%%M%% </span>Mins</li><li><span>%%S%%</span>Secs</li></ul>',
				FinishMessage: 'Expired',
			});
		});
	}
